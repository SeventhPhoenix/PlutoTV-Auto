(function() {
	...
	const CHANNEL_NAME_SUFFIXES = [' US Eastern Feed', ' Eastern Feed', ' US East', ' (US)', ' USA', ' USA Eastern', ',NY', ', NY'];
	...
	const getChannelMetaFromMaps = ({ id, streamName, channelMetaByStreamMap }) => {
		// Primary rule requested by user: playlist tvg-id should match JSON stream-name.
